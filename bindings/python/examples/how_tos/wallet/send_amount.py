...
# In this example we send funds from the wallet.
...
print(f'Balance before sending funds from the wallet: {total_base_token_balance}')
...
print(f'Balance after sending funds from the wallet: {total_base_token_balance}')
