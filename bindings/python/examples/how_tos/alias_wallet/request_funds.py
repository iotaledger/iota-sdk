...
print(f'Balance before requesting funds on alias address: {total_base_token_balance}')
...
print(f'Balance after requesting funds on alias address: {total_base_token_balance}')
