...
from iota_sdk import CreateNativeTokenParams, Wallet, utf8_to_hex, Irc30Metadata
...
metadata = Irc30Metadata("My Native Token", "MNT", 10, description="A native token to test the iota-sdk.")
