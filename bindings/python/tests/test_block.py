...
from iota_sdk import BasicBlock, BlockType, BlockWrapper, BasePayload, PayloadType
import pytest
...
def test_basic_block_with_tagged_data_payload():
    ...
    assert isinstance(block.payload, BasePayload)
...
def test_block_wrapper_with_tagged_data_payload():
    ...
    assert isinstance(block_wrapper.block.payload, BasePayload)
