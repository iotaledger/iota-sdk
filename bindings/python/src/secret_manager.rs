...
use iota_sdk_bindings_core::{
    ...
    iota_sdk::client::secret::{DynSecretManagerConfig, SecretManager as RustSecretManager, SecretManagerDto},
    SecretManagerMethod,
};
use pyo3::prelude::*;
...
pub struct SecretManager {
    pub secret_manager: Arc<RwLock<Box<dyn DynSecretManagerConfig>>>,
}
