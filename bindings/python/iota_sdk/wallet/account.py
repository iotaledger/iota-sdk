...
class Account:
    ...
    def build_basic_output(self, amount, native_tokens, unlock_conditions, features):
        """Build basic output."""
        return self._call_account_method(
            "buildBasicOutput",
            {
    ...
    def create_alias_output(self, alias_output_options, options):
        """Create an alias output."""
        return self._call_account_method(
            "createAliasOutput",
            {"aliasOutputOptions": alias_output_options, "options": options},
        )

    def generate_addresses(self, amount, options=None):
        """Generate new addresses."""
        return self._call_account_method(
            "generateAddresses", {"amount": amount, "options": options}
        )
    ...
    def get_output(self, output_id):
        """Get output."""
        return self._call_account_method("getOutput", {"outputId": output_id})
    ...
    def addresses(self):
        """List addresses."""
        return self._call_account_method("addresses")

    def addresses_with_unspent_outputs(self):
        """Returns only addresses of the account with unspent outputs."""
        return self._call_account_method("addressesWithUnspentOutputs")

    def outputs(self, filter_options=None):
        """Returns all outputs of the account."""
        return self._call_account_method("outputs", {"filterOptions": filter_options})

    def unspent_outputs(self, filter_options=None):
        """Returns all unspent outputs of the account."""
        return self._call_account_method(
            "unspentOutputs", {"filterOptions": filter_options}
        )

    def incoming_transactions(self):
        """Returns all incoming transactions of the account."""
        return self._call_account_method("incomingTransactions")

    def transactions(self):
        """Returns all transaction of the account."""
        return self._call_account_method("transactions")

    def pending_transactions(self):
        """Returns all pending transactions of the account."""
        return self._call_account_method("pendingTransactions")

    def decrease_native_token_supply(self, token_id, melt_amount, options=None):
        """Melt native tokens. This happens with the foundry output which minted them, by increasing it's
        `melted_tokens` field.
        """
        return self._call_account_method(
            "decreaseNativeTokenSupply",
            {"tokenId": token_id, "meltAmount": melt_amount, "options": options},
        )

    def increase_native_token_supply(
        self,
        token_id,
        mint_amount,
    ...
    def get_balance(self):
        ...
        return self._call_account_method("getBalance")
