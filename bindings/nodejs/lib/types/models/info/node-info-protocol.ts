...
class ProtocolParameters {
     ...
     */
    genesisUnixTimestamp?: string; //u64;
    /**
...
class RewardsParameters {
     ...
     */
    manaShareCoefficient?: string; //u64;
    /**
     ...
     */
    decayBalancingConstant?: string; //u64;
    /**
...
class CongestionControlParameters {
     ...
     */
    minReferenceManaCost?: string; //u64;
    /**
...
export { ProtocolInfo, ProtocolParameters, RewardsParameters, WorkScoreParameters, StorageScoreParameters, ManaParameters, VersionSignalingParameters, CongestionControlParameters, parseProtocolParameters};
