    ...
    let inputs = build_inputs(
        [
            Basic {
                ...
                native_token: Some((TOKEN_ID_1.to_string(), 150)),
                sender: None,
                sdruc: None,
                timelock: None,
                expiration: None,
            ...
            Basic {
                amount: 1_000_000,
                address: Address::try_from_bech32(BECH32_ADDRESS_ED25519_0).unwrap(),
                native_token: Some((TOKEN_ID_2.to_string(), 100)),
                sender: None,
                sdruc: None,
                timelock: None,
                expiration: None,
    ...
    let inputs = build_inputs(
        [
            Basic {
                amount: 2_000_000,
                address: Address::try_from_bech32(BECH32_ADDRESS_ED25519_0).unwrap(),
                native_token: Some((TOKEN_ID_1.to_string(), 100)),
                sender: None,
                sdruc: None,
                timelock: None,
                expiration: None,
            ...
            Basic {
                amount: 2_000_000,
                address: Address::try_from_bech32(BECH32_ADDRESS_ED25519_0).unwrap(),
                native_token: Some((TOKEN_ID_2.to_string(), 150)),
                sender: None,
                sdruc: None,
                timelock: None,
                expiration: None,
...
fn three_inputs_two_needed_plus_remainder() {
    ...
    let outputs = build_outputs([Basic {
        amount: 1_000_000,
        address: Address::try_from_bech32(BECH32_ADDRESS_ED25519_0).unwrap(),
        native_token: Some((TOKEN_ID_1.to_string(), 120)),
        sender: None,
        sdruc: None,
        timelock: None,
        expiration: None,
...
fn three_inputs_two_needed_no_remainder() {
    ...
    let outputs = build_outputs([Basic {
        amount: 2_000_000,
        address: Address::try_from_bech32(BECH32_ADDRESS_ED25519_0).unwrap(),
        native_token: Some((TOKEN_ID_1.to_string(), 200)),
        sender: None,
        sdruc: None,
        timelock: None,
        expiration: None,
...
fn insufficient_native_tokens_three_inputs() {
    ...
    let outputs = build_outputs([Basic {
        amount: 1_000_000,
        address: Address::try_from_bech32(BECH32_ADDRESS_ED25519_0).unwrap(),
        native_token: Some((TOKEN_ID_1.to_string(), 301)),
        sender: None,
        sdruc: None,
        timelock: None,
        expiration: None,
...
fn burn_and_send_at_the_same_time() {
    ...
    let outputs = build_outputs([Basic {
        amount: 1_000_000,
        address: Address::try_from_bech32(BECH32_ADDRESS_ED25519_0).unwrap(),
        native_token: Some((TOKEN_ID_1.to_string(), 50)),
        sender: None,
        sdruc: None,
        timelock: None,
        expiration: None,
...
fn two_basic_outputs_3() {
    ...
    let outputs = build_outputs([Basic {
        amount: 500_000,
        address: Address::try_from_bech32(BECH32_ADDRESS_ED25519_0).unwrap(),
        native_token: Some((TOKEN_ID_1.to_string(), 75)),
        sender: None,
        sdruc: None,
        timelock: None,
        expiration: None,
...
fn two_basic_outputs_6() {
    ...
    let outputs = build_outputs([Basic {
        amount: 500_000,
        address: Address::try_from_bech32(BECH32_ADDRESS_ED25519_0).unwrap(),
        native_token: Some((TOKEN_ID_1.to_string(), 250)),
        sender: None,
        sdruc: None,
        timelock: None,
        expiration: None,
...
fn two_basic_outputs_7() {
    ...
    let outputs = build_outputs([Basic {
        amount: 500_000,
        address: Address::try_from_bech32(BECH32_ADDRESS_ED25519_0).unwrap(),
        native_token: Some((TOKEN_ID_1.to_string(), 300)),
        sender: None,
        sdruc: None,
        timelock: None,
        expiration: None,
...
fn two_basic_outputs_8() {
    ...
    let outputs = build_outputs([Basic {
        amount: 500_000,
        address: Address::try_from_bech32(BECH32_ADDRESS_ED25519_0).unwrap(),
        native_token: Some((TOKEN_ID_1.to_string(), 350)),
        sender: None,
        sdruc: None,
        timelock: None,
        expiration: None,
        ...
        if !outputs.contains(output) {
            assert!(
                is_remainder_or_return(
                    ...
                    Address::try_from_bech32(BECH32_ADDRESS_ED25519_0).unwrap(),
                    Some((TOKEN_ID_1.to_string(), 300))
                ) || is_remainder_or_return(
                    output,
                    5_000_000 - nt_remainder_min_storage_deposit,
                    Address::try_from_bech32(BECH32_ADDRESS_ED25519_0).unwrap(),
                    Some((TOKEN_ID_2.to_string(), 100))
                )
            );
        }
    });
