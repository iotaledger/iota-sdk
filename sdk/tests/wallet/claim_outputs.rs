...
async fn claim_2_basic_micro_outputs() -> Result<()> {
    ...
    request_funds(&wallet_1, &secret_manager_1).await?;
    ...
    wallet_1
        .reissue_transaction_until_included(&secret_manager_1, &tx.transaction_id, None, None)
        .await?;

    // Claim with account 0
    let balance = wallet_0.sync(&secret_manager_0, None).await.unwrap();
    ...
    let tx = wallet_0
        ...
        .await?;
    wallet_0
        .reissue_transaction_until_included(&secret_manager_0, &tx.transaction_id, None, None)
        .await?;
...
async fn claim_1_of_2_basic_outputs() -> Result<()> {
    ...
    let tx = wallet_0
        .claim_outputs(
            &secret_manager_0,
            wallet_0.claimable_outputs(OutputsToClaim::Amount).await?,
        )
        .await?;
    wallet_0
        .reissue_transaction_until_included(&secret_manager_0, &tx.transaction_id, None, None)
...
async fn claim_2_basic_outputs_no_outputs_in_claim_account() -> Result<()> {
    ...
    let tx = wallet_0.send_outputs(&secret_manager_0, outputs, None).await?;
    ...
    let tx = wallet_1
        .claim_outputs(
            &secret_manager_1,
            wallet_1.claimable_outputs(OutputsToClaim::All).await?,
        )
        .await?;
    wallet_1
        .reissue_transaction_until_included(&secret_manager_1, &tx.transaction_id, None, None)
...
async fn claim_2_native_tokens() -> Result<()> {
    ...
    let tx = wallet_1.create_account_output(&secret_manager_1, None, None).await?;
    wallet_1
        .reissue_transaction_until_included(&secret_manager_1, &tx.transaction_id, None, None)
        .await?;
    ...
    let create_tx_0 = wallet_1
        ...
        .await?;
    wallet_1
        .reissue_transaction_until_included(&secret_manager_1, &create_tx_0.transaction.transaction_id, None, None)
        .await?;
    wallet_1.sync(&secret_manager_1, None).await?;
    ...
    let create_tx_1 = wallet_1
        ...
        .await?;
    wallet_1
        .reissue_transaction_until_included(&secret_manager_1, &create_tx_1.transaction.transaction_id, None, None)
        .await?;
    wallet_1.sync(&secret_manager_1, None).await?;
    ...
    let tx = wallet_0
        .claim_outputs(
            &secret_manager_0,
            wallet_0.claimable_outputs(OutputsToClaim::NativeTokens).await?,
        )
        .await?;
    wallet_0
        .reissue_transaction_until_included(&secret_manager_0, &tx.transaction_id, None, None)
...
async fn claim_2_native_tokens_no_outputs_in_claim_account() -> Result<()> {
    ...
    let tx = wallet_0.create_account_output(&secret_manager_0, None, None).await?;
    wallet_0
        .reissue_transaction_until_included(&secret_manager_0, &tx.transaction_id, None, None)
        .await?;
    wallet_0.sync(&secret_manager_0, None).await?;
    ...
    let create_tx_0 = wallet_0
        ...
        .await?;
    wallet_0
        .reissue_transaction_until_included(&secret_manager_0, &create_tx_0.transaction.transaction_id, None, None)
        .await?;
    wallet_0.sync(&secret_manager_0, None).await?;
    ...
    let create_tx_1 = wallet_0
        ...
        .await?;
    wallet_0
        .reissue_transaction_until_included(&secret_manager_0, &create_tx_1.transaction.transaction_id, None, None)
        .await?;
    wallet_0.sync(&secret_manager_0, None).await?;
    ...
    let tx = wallet_1
        .claim_outputs(
            &secret_manager_1,
            wallet_1.claimable_outputs(OutputsToClaim::NativeTokens).await?,
        )
        .await?;
    wallet_1
        .reissue_transaction_until_included(&secret_manager_1, &tx.transaction_id, None, None)
...
async fn claim_2_nft_outputs() -> Result<()> {
    ...
    let tx = wallet_1.send_outputs(&secret_manager_1, outputs, None).await?;
    wallet_1
        .reissue_transaction_until_included(&secret_manager_1, &tx.transaction_id, None, None)
        .await?;
    ...
    let tx = wallet_0
        .claim_outputs(
            &secret_manager_0,
            wallet_0.claimable_outputs(OutputsToClaim::Nfts).await?,
        )
        .await?;
    wallet_0
        .reissue_transaction_until_included(&secret_manager_0, &tx.transaction_id, None, None)
...
async fn claim_2_nft_outputs_no_outputs_in_claim_account() -> Result<()> {
    ...
    let tx = wallet_1
        .claim_outputs(
            &secret_manager_1,
            wallet_1.claimable_outputs(OutputsToClaim::Nfts).await?,
        )
        .await?;
    wallet_1
        .reissue_transaction_until_included(&secret_manager_1, &tx.transaction_id, None, None)
