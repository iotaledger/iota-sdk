...
async fn claim_2_native_tokens() -> Result<()> {
    ...
    let create_tx_0 = wallet_1
        ...
        .await?;
    wallet_1
        .await_transaction_acceptance(&create_tx_0.transaction.transaction_id, None, None)
        .await?;
    wallet_1.sync(None).await?;
    ...
    let create_tx_1 = wallet_1
        ...
        .await?;
    wallet_1
        .await_transaction_acceptance(&create_tx_1.transaction.transaction_id, None, None)
        .await?;
    wallet_1.sync(None).await?;
