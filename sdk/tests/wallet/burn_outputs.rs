...
async fn create_and_melt_native_token() -> Result<()> {
    ...
    wallet
        .await_transaction_acceptance(&create_transaction.transaction.transaction_id, None, None)
        .await?;
    let balance = wallet.sync(None).await.unwrap();
...
async fn create_and_burn_native_tokens() -> Result<()> {
    ...
    wallet
        .await_transaction_acceptance(&tx.transaction_id, None, None)
        .await?;
    wallet.sync(None).await?;
    ...
    let create_tx = wallet
        ...
        .await?;
    wallet
        .await_transaction_acceptance(&create_tx.transaction.transaction_id, None, None)
        .await?;
    wallet.sync(None).await?;
...
async fn mint_and_burn_nft_with_account() -> Result<()> {
    ...
    wallet
        .await_transaction_acceptance(&nft_tx.transaction_id, None, None)
        .await?;
    ...
    let burn_tx = wallet
        ...
        .await?;
    wallet
        .await_transaction_acceptance(&burn_tx.transaction_id, None, None)
        .await?;
    let balance = wallet.sync(None).await?;
