...
impl DelegationOutputBuilder {
    ...
    pub fn finish_output(self, token_supply: u64) -> Result<Output, Error> {
        Ok(Output::Delegation(self.finish(token_supply)?))
    }
}
...
pub mod dto {
    ...
    impl DelegationOutput {
        pub fn try_from_dto(value: DelegationOutputDto, token_supply: u64) -> Result<Self, Error> {
            ...
            builder = builder.with_start_epoch(value.start_epoch);
            builder = builder.with_end_epoch(value.end_epoch);
        ...
        pub fn try_from_dto_unverified(value: DelegationOutputDto) -> Result<Self, Error> {
            let mut builder = DelegationOutputBuilder::new_with_amount(
                value.amount.parse::<u64>().map_err(|_| Error::InvalidField("amount"))?,
                value
                    .delegated_amount
