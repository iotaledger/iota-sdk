...
pub fn hex_to_bech32(hex: &str, bech32_hrp: Hrp) -> Result<Bech32Address> {
...
pub fn hex_public_key_to_bech32_address(hex: &str, bech32_hrp: Hrp) -> Result<Bech32Address> {
...
pub async fn request_funds_from_faucet(url: &str, bech32_address: impl Borrow<Bech32Address> + Send) -> Result<String> {
...
impl Client {
    ...
    /// Transforms a hex encoded address to a bech32 encoded address
    pub async fn hex_to_bech32(&self, hex: &str, bech32_hrp: Option<Hrp>) -> crate::client::Result<Bech32Address> {
        match bech32_hrp {
