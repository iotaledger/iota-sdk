...
public class PrepareAndSignTransaction {
    public static void main(String[] args) throws ClientException, InitializeClientException {
        ...
        // NOTE: `YOUR_SECRET_MNEMONIC` serves as a placeholder. Replace it with the
        // mnemonic you want to use to sign the transaction.
        SecretManager secretManager = new MnemonicSecretManager("YOUR_SECRET_MNEMONIC");

        // Build the output for the transaction.
        String receiverAddress = client.generateEd25519Addresses(secretManager,
        ...
        BuildBlockOptions.ClientBlockBuilderOutputAddress output = new BuildBlockOptions.ClientBlockBuilderOutputAddress(
                receiverAddress, Integer.toString(1000000));
