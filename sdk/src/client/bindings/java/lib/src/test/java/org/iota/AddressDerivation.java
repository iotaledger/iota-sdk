...
public class AddressDerivation extends ApiTest {
    ...
    public void testAddressDerivation() throws ClientException, InitializeClientException {
        ...
        String wrongAddress = client
                .hexToBech32(
                        client.bech32ToHex(client.generateEd25519Addresses(wrongSecretManager,
                                new GenerateAddressesOptions().withRange(new Range(0, 1)).withCoinType(4218))[0]),
                        "atoi");
        String correctAddress = client
                .hexToBech32(
                        client.bech32ToHex(client.generateEd25519Addresses(correctSecretManager,
                                new GenerateAddressesOptions().withRange(new Range(0, 1)).withCoinType(4218))[0]),
                        "atoi");

        if (wrongAddress.equals("atoi1qzzj3wa2c0m0mpe6s2v004037sjhyk7zgr7hj3umwgnanr9xy6c92qyz3c8")
                && correctAddress.equals("atoi1qp5dzudmpxxz7xxlzez8w5ttefeanhpf9rju48ds5y2ellp6aauuztf0dyd")) {
