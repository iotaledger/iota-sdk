...
use crate::{
    client::{storage::StorageAdapter, stronghold::StrongholdAdapter},
    types::TryFromDto,
    wallet::{
...
pub(crate) async fn read_wallet_data_from_stronghold_snapshot(
...
) -> crate::wallet::Result<(Option<ClientOptions>, Option<WalletData>)> {
    ...
    Ok((client_options, restored_wallet_data))
}
