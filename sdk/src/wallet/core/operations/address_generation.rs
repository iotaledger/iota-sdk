...
// use crate::{
//     client::secret::{Generate, SecretManage, SecretManager},
...
//         account_index: u32,
//         address_index: u32,
//         options: &S::GenerationOptions,
//     ) -> crate::wallet::Result<Ed25519Address> { // TODO #1279: not sure yet whether we also should allow this method
