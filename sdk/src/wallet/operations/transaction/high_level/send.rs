...
impl Wallet {
    ...
    pub async fn send<S: 'static + SecretManage>(
        &self,
        secret_manager: &S,
        amount: u64,
        address: impl ConvertTo<Bech32Address>,
        ...
        crate::client::Error: From<S::Error>,
    {
        ...
        self.send_with_params(secret_manager, params, options).await
    }
    ...
    /// }
    /// ```
    pub async fn send_with_params<I: IntoIterator<Item = SendParams> + Send, S: 'static + SecretManage>(
        &self,
        secret_manager: &S,
        params: I,
        options: impl Into<Option<TransactionOptions>> + Send,
        ...
        crate::client::Error: From<S::Error>,
    {
        ...
        self.sign_and_submit_transaction(secret_manager, prepared_transaction, options)
            .await
    }
