...
impl Wallet {
    ...
    pub async fn implicit_account_transition<S: 'static + SecretManage>(
        &self,
        secret_manager: &S,
        output_id: &OutputId,
        ...
        crate::client::Error: From<S::Error>,
    {
        self.sign_and_submit_transaction(
            secret_manager,
            self.prepare_implicit_account_transition(secret_manager, output_id)
                .await?,
            None,
        )
        .await
    ...
    pub async fn prepare_implicit_account_transition<S: SecretManage>(
        &self,
        secret_manager: &S,
        output_id: &OutputId,
