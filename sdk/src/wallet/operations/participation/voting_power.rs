...
impl Wallet {
    ...
    pub async fn increase_voting_power<S: 'static + SecretManage>(
        &self,
        secret_manager: &S,
        amount: u64,
        ...
        crate::client::Error: From<S::Error>,
    {
        ...
        self.sign_and_submit_transaction(secret_manager, prepared, None).await
    }
    ...
    pub async fn decrease_voting_power<S: 'static + SecretManage>(
        &self,
        secret_manager: &S,
        amount: u64,
    ) -> Result<TransactionWithMetadata>
