...
public class Account extends AbstractObject {
    ...
    public Account(Wallet wallet, AccountIdentifier accountIdentifier) {
        this.wallet = wallet;
     ...
     */
    public AccountDetails getAccountCopy() throws WalletException {
        JsonObject o = new JsonObject();
        o.add("accountId", CustomGson.get().toJsonTree(accountIdentifier));

        return CustomGson.get().fromJson(callBaseApi(new WalletCommand("getAccount", o)), AccountDetails.class);
    }
...
class AccountAdapter implements JsonSerializer<Account> {
    @Override
