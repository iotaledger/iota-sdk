...
public class CheckUnlockConditions {
        public static void main(String[] args) throws WalletException, InterruptedException, InitializeWalletException {
                ...
                // Build an output.
                Output output = a.prepareOutput(new PrepareOutput().withParams(new OutputParams()
                                .withAmount("1000000")
                ...
                AddressUnlockCondition addressUnlockCondition = (AddressUnlockCondition) basicOutput
                                .getUnlockConditions()[0];
