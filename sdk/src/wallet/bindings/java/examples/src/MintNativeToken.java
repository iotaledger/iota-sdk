...
public class MintNativeToken {
        public static void main(String[] args) throws WalletException, InterruptedException, InitializeWalletException {
                ...
                MintNativeTokenParams params = new MintNativeTokenParams();
                params.withCirculatingSupply("0x20"); // number 23 hex encoded
                params.withMaximumSupply("0x45"); // number 69 hex encoded

                // Send transaction.
                MintTokenTransaction mint = a
                                .mintNativeToken(
                                                new org.iota.types.account_methods.MintNativeToken()
                                                                .withParams(params));
