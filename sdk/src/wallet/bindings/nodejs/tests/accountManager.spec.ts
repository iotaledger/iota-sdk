...
describe('AccountManager', () => {
    it('create account', async () => {
        ...
        await accountManager.storeMnemonic(
    ...
    it('generate address', async () => {
        ...
        const address = await accountManager.generateEd25519Address(
            0,
            0,
        ...
        const anotherAddress = await accountManager.generateEd25519Address(
            10,
            10,
