---
title: Output Unlock Conditions
description: 'How to create ouputs with different unlock conditions'
...
import RustCode from '!!raw-loader!../../../../../sdk/examples/how_tos/outputs/output_unlock_conditions.rs';
import NodejsCode from '!!raw-loader!../../../../../bindings/nodejs/examples/how_tos/outputs/output_unlock_conditions.ts';
import PythonCode from '!!raw-loader!../../../../../bindings/python/examples/how_tos/outputs/output_unlock_conditions.py';
...
1. Create multiple outputs with all possible features
