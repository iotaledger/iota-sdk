...
class Build extends clipanion_1.Command {
    static paths = [[`build`]];
    ...
    async execute() {
        ...
        return await (0, shell_1.execute)('npx docusaurus build --config', [internalConfig, directory], {
            env: {
